...
class EpochStatusWindow:
    def __init__(self):
        ...
        self.root.geometry("500x500")  # Slightly increased height to accommodate the stop button
    ...
    def setup_ui(self):
        ...
        # Create a more visible stop button
        self.stop_button = tk.Button(
            ...
            height=2,
            state=tk.NORMAL  # Enable by default so it's visible, we'll check in the stop_training method
        )
        self.stop_button.pack(fill=tk.X, padx=20, pady=10)
        
        # Status message for the interruption
    ...
    def update_ui(self, data):
        ...
        if "epoch" in data and "total_epochs" in data:
            ...
            # Enable stop button when training is in progress
    ...
    def stop_training(self):
        # Check if we're actually in a training session
