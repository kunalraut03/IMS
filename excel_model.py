...
while True:
    ...
    try:
        ...
        if key == ord(' '):
            ...
            if current_timestamp - last_registration_attempt < 1.0:
                remaining_time = 1.0 - (current_timestamp - last_registration_attempt)
                ...
                last_registration_attempt = current_timestamp
